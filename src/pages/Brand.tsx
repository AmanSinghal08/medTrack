...
import { 
  ...
  Award, Factory, Tag, LayoutGrid
} from 'lucide-react';

interface Brand {
  id: string;
  name: string;        // The Brand Name (e.g., "Dolo")
  companyName: string; // The parent manufacturing company (e.g., "Micro Labs")
}
...
export default function Brand() {
  ...
  const [brands, setBrands] = useState<Brand[]>([
    { id: '1', name: 'Dolo', companyName: 'Micro Labs Ltd' },
    { id: '2', name: 'Crocin', companyName: 'GlaxoSmithKline' },
    { id: '3', name: 'Becosules', companyName: 'Pfizer' },
  ]);
  ...
  const handleSave = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newBrand: Brand = {
      id: editingBrand?.id || Math.random().toString(36).substr(2, 9),
      name: data.name,
            ...
            <form onSubmit={handleSave} className="p-8 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    name="companyName" 
                    defaultValue={editingBrand?.companyName} 
                    required 
